...
class NotificationFrame ( wx.Frame ):
    ...
    def __init__( self, parent,version ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = wx.EmptyString, pos = wx.DefaultPosition, size = wx.Size( 299,156 ), style = wx.NO_BORDER|wx.FRAME_NO_TASKBAR|wx.STAY_ON_TOP )
        ...
        self.m_staticText3 = wx.StaticText( self, wx.ID_ANY, _("Available the new version")+' Vertaler '+str(version), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_staticText2 = wx.StaticText( self, wx.ID_ANY, _("you can download and install it"), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_hyperlink1 = wx.HyperlinkCtrl( self, wx.ID_ANY, u"www.vertalerproject.org", u"http://vertaler.weebly.com/downloads.html", wx.DefaultPosition, wx.DefaultSize, wx.HL_DEFAULT_STYLE )
        ...
        self.m_bitmap1 = wx.StaticBitmap( self, wx.ID_ANY, wx.Bitmap( u"./src/icons/popupframe/delete_icon&16.png", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, 0 )
