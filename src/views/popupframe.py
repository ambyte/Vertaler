...
class PopUpFrame ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.p_bitmapTranslate = wx.StaticBitmap( self, wx.ID_ANY, wx.Bitmap( u"./src/icons/popupframe/refresh_icon&16.png", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.p_bitmapCopy = wx.StaticBitmap( self, wx.ID_ANY, wx.Bitmap( u"./src/icons/popupframe/clipboard_copy_icon&16.png", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, 0 )
        self.p_bitmapCopy.SetToolTipString( _("Copy text") )
        self.p_bitmapCopy.SetCursor(cursor)

        bSizer.Add( self.p_bitmapCopy, 0, wx.ALL, 3 )

        self.p_bitmapSearch = wx.StaticBitmap( self, wx.ID_ANY, wx.Bitmap( u"./src/icons/popupframe/zoom_icon&16.png", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.p_bitmapOpenMain = wx.StaticBitmap( self, wx.ID_ANY, wx.Bitmap( u"./src/icons/popupframe/home_icon&16.png", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.p_bitmapClose = wx.StaticBitmap( self, wx.ID_ANY, wx.Bitmap( u"./src/icons/popupframe//delete_icon&16.png", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, 0 )
